...
mueve(){
    ...
    */
    /* Actualizamos el ángulo de radianes según la nomenclatura de ángulos de 0 a 3 */
    ...
    /* Va cambiando de estado de animación para caminar */
    this.estadoanim++;
    ...
    persigue(){
        this.estadoanim++;
        if(this.estadoanim > 7){this.estadoanim = 0;}
        /* Hago esto para que los personajes me persigan */
    ...
    cambiadireccion(){
        /* Aquí le indicamos al programa que el personaje cambia de dirección cada 100 unidades de tiempo */
    ...
    colisiona(){
        ...
        */
        var colisionapixel = contextomapa.getImageData(this.x/50,this.y/50,1,1);
