...
maparecogibles.src = "img/mapas/mapa6recogibles.png";

var mapaprops = new Image();
mapaprops.src = "img/mapas/mapa6props.png";

var bloque9 = new Image();
bloque9.src = "img/terreno/terreno9.png";

var bloqueacera = new Image();
bloqueacera.src = "img/terreno/acera.png";

var bloqueasfalto = new Image();
bloqueasfalto.src = "img/terreno/asfalto.png";

var bloquejardin = new Image();
bloquejardin.src = "img/terreno/jardin.png";

var bloquepavimento = new Image();
bloquepavimento.src = "img/terreno/pavimento.png";

var bloquepavimentocasa = new Image();
bloquepavimentocasa.src = "img/terreno/pavimentocasa.png";

var bloquevallajardin = new Image();
bloquevallajardin.src = "img/terreno/vallajardin.png";

var bloquearquitecturasimple1 = new Image();
bloquearquitecturasimple1.src = "img/arquitectura/simple1-1.png";

var bloquearquitecturasimple2 = new Image();
bloquearquitecturasimple2.src = "img/arquitectura/simple2-1.png";

var bloquearquitecturax = new Image();
bloquearquitecturax.src = "img/arquitectura/cruz.png";

var bloquearquitectural1 = new Image();
bloquearquitectural1.src = "img/arquitectura/l1.png";
var bloquearquitectural2 = new Image();
bloquearquitectural2.src = "img/arquitectura/l2.png";
var bloquearquitectural3 = new Image();
bloquearquitectural3.src = "img/arquitectura/l3.png";
var bloquearquitectural4 = new Image();
bloquearquitectural4.src = "img/arquitectura/l4.png";

var bloquearquitecturat1 = new Image();
bloquearquitecturat1.src = "img/arquitectura/t1.png";
var bloquearquitecturat2 = new Image();
bloquearquitecturat2.src = "img/arquitectura/t2.png";
var bloquearquitecturat3 = new Image();
bloquearquitecturat3.src = "img/arquitectura/t3.png";
var bloquearquitecturat4 = new Image();
bloquearquitecturat4.src = "img/arquitectura/t4.png";

var bloquearquitecturaventana1 = new Image();
bloquearquitecturaventana1.src = "img/arquitectura/ventana1.png";
var bloquearquitecturaventana2 = new Image();
bloquearquitecturaventana2.src = "img/arquitectura/ventana2.png";



var bloquearquitecturasimple1a = new Image();
bloquearquitecturasimple1.src = "img/arquitectura/simple1.png";

var bloquearquitecturasimple2a = new Image();
bloquearquitecturasimple2.src = "img/arquitectura/simple2.png";

var bloquearquitecturaxa = new Image();
bloquearquitecturaxa.src = "img/arquitectura/cruz-1.png";

var bloquearquitectural1a = new Image();
bloquearquitectural1a.src = "img/arquitectura/l1-1.png";
var bloquearquitectural2a = new Image();
bloquearquitectural2a.src = "img/arquitectura/l2-1.png";
var bloquearquitectural3a = new Image();
bloquearquitectural3a.src = "img/arquitectura/l3-1.png";
var bloquearquitectural4a = new Image();
bloquearquitectural4a.src = "img/arquitectura/l4-1.png";

var bloquearquitecturat1a = new Image();
bloquearquitecturat1a.src = "img/arquitectura/t1-1.png";
var bloquearquitecturat2a = new Image();
bloquearquitecturat2a.src = "img/arquitectura/t2-1.png";
var bloquearquitecturat3a = new Image();
bloquearquitecturat3a.src = "img/arquitectura/t3-1.png";
var bloquearquitecturat4a = new Image();
bloquearquitecturat4a.src = "img/arquitectura/t4-1.png";

var bloquearquitecturaventana1a = new Image();
bloquearquitecturaventana1a.src = "img/arquitectura/ventana1-1.png";
var bloquearquitecturaventana2a = new Image();
bloquearquitecturaventana2a.src = "img/arquitectura/ventana2-1.png";

var bloquetecho= new Image();
bloquetecho.src = "img/arquitectura/techo.png";


var imagenbalon = new Image();
imagenbalon.src = "img/items/premio.png";
