...
include "../admin/inc/condicionesdeinicio.php";
                    ...
                    while ($fila2 = $resultado2->fetch_array()){
                       if(@json_decode($fila2["Comment"])->titulo == ""){
                          echo '<li><a href="?tabla='.$fila[0].'"><i class="fas fa-arrow-circle-right"></i>'.$fila[0].'></a></li>';  
                            ...
                            echo '<li><a href="?tabla='.$fila[0].'" tittle="'.json_decode($fila2["Comment"])->descripcion.'"> <i class="'.json_decode($fila2["Comment"])->icono.'"></i> '.json_decode($fila2["Comment"])->titulo.'</a></li>';
                       } 
