  ...
  return (
    <div>
      ...
      <div className="container projects-intro">
        <div className="row flex-with-center mt-5">
          <div className="col-md-6 n-box2 px-3 py-5" data-aos='fade-down'>
            <div>
              <h1 className="font-bold">Projectos</h1>
              <p className="font-bold">
              Las buenas ideas no se adoptan automáticamente. 
              Deben llevarse a la práctica con valiente paciencia.
              </p>
              <button className="primary-button projects-btn"><a href="#projects-list" className='white'>Start</a></button>
            </div>
          </div>
      ...
      <div className="container projects-list" id='projects-list'>
          ...
          <h3 className="font-bold">Echa un vistazo a mis Projectos</h3>
          <hr />
