...
function Home() {
  return (
    <div>
      ...
      >
        <div>
          <h1 data-aos='fade-up'>JUAN JOSE GALAN CHILET</h1>
        ...
        <div className="row justify-content-start">
          <div className="col-md-4">
            <div className="n-box2 p-5 font-bold" data-aos='fade-right'>
              <h1>Si tu puedes...</h1>
              <br />
              <p>Soy un fanático de Javascript</p>
            </div>
          </div>
        </div>
        ...
        <div className="row pt-5 justify-content-end">
          <div className="col-md-4">
            <div className="n-box2 p-5 font-bold" data-aos='fade-left'>
              <p>
              JavaScript es uno de los lenguajes de programación mejor 
              clasificados debido a su uso ubicuo en todas las plataformas 
              y su adopción masiva. Principales casos de uso: Desarrollo web
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="devstack container my-5 n-box2 py-5">
        <div className="text-center">
          <h3 className="font-bold text-center">Mi stack de desarrollo</h3>
      ...
      <div>
      <h3 className='font-bold text-center'>Quien es Juan José?</h3>
      <div className="who-is-sathya flex-with-center" style={{backgroundImage:`url('/whoissathya.svg')`}}>
         
      <div>
        <h3>Hola que tal?</h3>
        <hr />
        <p>Nombre: Juan José Galán Chilet</p>
        <p>País: España</p>
        <p>Email: Jugach21@gmail.com</p>
        <p>Teléfono: 662250947</p>
      </div>
